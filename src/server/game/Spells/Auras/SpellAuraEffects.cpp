...
void AuraEffect::HandleFeignDeath(AuraApplication const* aurApp, uint8 mode, bool apply) const
{
    ...
    if (apply)
    {
        ...
        */
        ...
        UnitList targets;
		MoPCore::AnyUnfriendlyUnitInObjectRangeCheck u_check(target, target, target->GetMap()->GetVisibilityRange());
		MoPCore::UnitListSearcher<MoPCore::AnyUnfriendlyUnitInObjectRangeCheck> searcher(target, targets, u_check);
                ...
                case 51690:
                {
                    ...
                    if (target->HasAura(13877))
                    {
                        ...
                        UnitList targets;
                        {
							...
							MoPCore::AnyUnfriendlyAttackableVisibleUnitInObjectRangeCheck u_check(target, radius);
							MoPCore::UnitListSearcher<MoPCore::AnyUnfriendlyAttackableVisibleUnitInObjectRangeCheck> checker(target, targets, u_check);

							TypeContainerVisitor<MoPCore::UnitListSearcher<MoPCore::AnyUnfriendlyAttackableVisibleUnitInObjectRangeCheck>, GridTypeMapContainer > grid_object_checker(checker);
							TypeContainerVisitor<MoPCore::UnitListSearcher<MoPCore::AnyUnfriendlyAttackableVisibleUnitInObjectRangeCheck>, WorldTypeMapContainer > world_object_checker(checker);
						...
						Unit* spellTarget = sObjectAccessor->FindUnit(MoPCore::Containers::SelectRandomContainerElement(validTargets));
