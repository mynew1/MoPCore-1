...
void AchievementMgr<T>::SendAchievementEarned(AchievementEntry const* achievement) const
{
    ...
    {
		MoPCore::AchievementChatBuilder say_builder(*GetOwner(), CHAT_MSG_GUILD_ACHIEVEMENT, LANG_ACHIEVEMENT_EARNED, achievement->ID);
		MoPCore::LocalizedPacketDo<MoPCore::AchievementChatBuilder> say_do(say_builder);
    ...
    {
		CellCoord p = MoPCore::ComputeCellCoord(GetOwner()->GetPositionX(), GetOwner()->GetPositionY());

        Cell cell(p);
        cell.SetNoCreate();

		MoPCore::AchievementChatBuilder say_builder(*GetOwner(), CHAT_MSG_ACHIEVEMENT, LANG_ACHIEVEMENT_EARNED, achievement->ID);
		MoPCore::LocalizedPacketDo<MoPCore::AchievementChatBuilder> say_do(say_builder);
		MoPCore::PlayerDistWorker<MoPCore::LocalizedPacketDo<MoPCore::AchievementChatBuilder> > say_worker(GetOwner(), sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_SAY), say_do);
		TypeContainerVisitor<MoPCore::PlayerDistWorker<MoPCore::LocalizedPacketDo<MoPCore::AchievementChatBuilder> >, WorldTypeMapContainer > message(say_worker);
