...
class MotionMaster //: private std::stack<MovementGenerator *>
{
    ...
    public:
		...
		void MovePoint2(uint32 id, Position const& pos, bool generatePath = true)
		{
			MovePoint2(id, pos.m_positionX, pos.m_positionY, pos.m_positionZ, generatePath);
		}
		void MovePoint2(uint32 id, float x, float y, float z, bool generatePath = true);
