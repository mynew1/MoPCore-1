...
class MapManager
{
    ...
    public:
        ...
        {
			return IsValidMAP(mapid, false) && MoPCore::IsValidMapCoord(x, y);
        }

        static bool IsValidMapCoord(uint32 mapid, float x, float y, float z)
        {
			return IsValidMAP(mapid, false) && MoPCore::IsValidMapCoord(x, y, z);
        }

        static bool IsValidMapCoord(uint32 mapid, float x, float y, float z, float o)
        {
			return IsValidMAP(mapid, false) && MoPCore::IsValidMapCoord(x, y, z, o);
        }
