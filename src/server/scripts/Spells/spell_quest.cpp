    ...
    public:
        ...
        class spell_q11010_q11102_q11023_choose_loc_SpellScript : public SpellScript
        {
            ...
            void HandleDummy(SpellEffIndex /*effIndex*/)
            {
				...
				MoPCore::AnyPlayerInObjectRangeCheck checker(caster, 765.0f);
				MoPCore::PlayerListSearcher<MoPCore::AnyPlayerInObjectRangeCheck> searcher(caster, PlayerList, checker);
