        ...
        struct npc_simon_bunnyAI : public ScriptedAI
        {
            ...
            */
            void StartGame()
            {
				...
				MoPCore::AllWorldObjectsInRange objects(me, searchDistance);
				MoPCore::WorldObjectListSearcher<MoPCore::AllWorldObjectsInRange> searcher(me, ClusterList, objects);
