    ...
    public:
        ...
        struct boss_hodirAI : public BossAI
        {
            ...
            void RemoveTraps()
            {
				...
				MoPCore::CreatureListSearcher<FreezeTrapSearcher> searcher(me, freezeTraps, check);
            ...
            void FlashFreeze()
            {
				...
				MoPCore::AnyUnfriendlyUnitInObjectRangeCheck checker(me, me, 100.0f);
				MoPCore::UnitListSearcher<MoPCore::AnyUnfriendlyUnitInObjectRangeCheck> searcher(me, TargetList, checker);
                        ...
                        case EVENT_STORM_CLOUD:
                            {
								...
								MoPCore::AnyFriendlyUnitInObjectRangeCheck checker(me, me, 30.0f);
								MoPCore::UnitListSearcher<MoPCore::AnyFriendlyUnitInObjectRangeCheck> searcher(me, allies, checker);
