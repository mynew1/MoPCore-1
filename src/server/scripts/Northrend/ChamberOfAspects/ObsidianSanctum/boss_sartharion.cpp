...
public:
    ...
    struct boss_sartharionAI : public ScriptedAI
    {
        ...
        void CastLavaStrikeOnTarget(Unit* target)
        {
			...
			MoPCore::AllCreaturesOfEntryInRange checker(me, NPC_FIRE_CYCLONE, 200.0f);
			MoPCore::CreatureListSearcher<MoPCore::AllCreaturesOfEntryInRange> searcher(me, pFireCyclonesList, checker);
