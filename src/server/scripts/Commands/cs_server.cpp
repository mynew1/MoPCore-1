...
public:
    ...
    static bool HandleServerInfoCommand(ChatHandler* handler, char const* /*args*/)
    {
        ...
        handler->PSendSysMessage("MoPCore Mists of Pandaria Development 5.4.8");
        handler->PSendSysMessage("MoPCore Core: Last Update: 22.08.2015 Updatepack: 2");
        handler->PSendSysMessage("MoPCore DB: Last Update: 22.08.2015 Updatepack: 20");
